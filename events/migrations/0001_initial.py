# Generated by Django 5.1.4 on 2025-08-09 15:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['is_active', 'is_marquee'], name='events_noti_is_acti_d73152_idx'),
        ),
        migrations.AddIndex(
            model_name='notification',
            index=models.Index(fields=['start_date', 'end_date'], name='events_noti_start_d_fa93c8_idx'),
        ),
        migrations.AddIndex(
            model_name='notification',
            index=models.Index(fields=['priority', 'notification_type'], name='events_noti_priorit_1d35e4_idx'),
        ),
    ]
